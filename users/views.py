...
def kakao_callback(request):
    try:
        ...
        try:
            ...
            user = models.User.objects.create(email=email, username=email, first_name=nickname, login_method=models.User.LOGIN_KAKAO, email_verified=True)
            user.set_unusable_password()
            user.save()
...
class UpdateProfielView(mixins.LoggedInOnlyView, SuccessMessageMixin, UpdateView):
    model = models.User
